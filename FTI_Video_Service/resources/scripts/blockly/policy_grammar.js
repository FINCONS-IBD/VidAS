...
yy: {},
symbols_: {"error":2,"expressions":3,"complex_statement":4,"EOF":5,"ATTRIBUTE":6,"AND":7,"OR":8,"(":9,")":10,"$accept":0,"$end":1},
terminals_: {2:"error",5:"EOF",6:"ATTRIBUTE",7:"AND",8:"OR",9:"(",10:")"},
productions_: [0,[3,2],[4,1],[4,3],[4,3],[4,3]],
performAction: function anonymous(yytext, yyleng, yylineno, yy, yystate, $$, _$) {
/* this == yyval */
...
case 2:this.$ = yytext;
break;
case 3:this.$ = $$[$0-2]+" AND "+$$[$0];
break;
case 4:this.$ = $$[$0-2]+" OR "+$$[$0];
break;
case 5:this.$ = "("+ $$[$0-1]+")";
break;
}
},
table: [{3:1,4:2,6:[1,3],9:[1,4]},{1:[3]},{5:[1,5],7:[1,6],8:[1,7]},{5:[2,2],7:[2,2],8:[2,2],10:[2,2]},{4:8,6:[1,3],9:[1,4]},{1:[2,1]},{4:9,6:[1,3],9:[1,4]},{4:10,6:[1,3],9:[1,4]},{7:[1,6],8:[1,7],10:[1,11]},{5:[2,3],7:[2,3],8:[2,3],10:[2,3]},{5:[2,4],7:[2,4],8:[2,4],10:[2,4]},{5:[2,5],7:[2,5],8:[2,5],10:[2,5]}],
...
rules: [/^(?:\s+)/,/^(?:([a-zA-Z0-9-_.&])+:([a-zA-Z0-9-_.&@])+)/,/^(?:\()/,/^(?:OR\b)/,/^(?:AND\b)/,/^(?:\))/,/^(?:$)/,/^(?:.)/],
